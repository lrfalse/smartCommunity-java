...
@Controller
public class OpenControllerxxx {

    @Autowired
    EntraceGuardService entraceGuardService;
    private static final Logger LOGGER = LoggerFactory.getLogger(OpenControllerxxx.class);
   ...
   // @PostMapping("secert")
    @ResponseBody
    public Object getSecertt(@RequestBody Secret secert) {
        // 创建默认的httpClient实例.
        CloseableHttpClient httpclient = HttpClients.createDefault();
        // 创建httppost
        HttpPost httppost = new HttpPost("http://open.meilinapi.com/");
    ...
    public List bulidGetSecert(Secret secert) {
