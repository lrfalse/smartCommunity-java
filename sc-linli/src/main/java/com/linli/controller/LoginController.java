...
public class LoginController {
   ...
   String url = "http://restapi.amap.com/v3/place/text?key=264d80231fd6ab84d409310b74b6ad98&keywords=桓大·泰晤士清晨&city=永川区&citylimit=true&children=5&offset=24&page=1&extensions=all";
    @GetMapping("/XXOO")
    @ResponseBody
    public String run() {
