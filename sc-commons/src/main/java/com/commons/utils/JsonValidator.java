...
/**
  * @Description(功能描述): 用于校验一个字符串是否是合法的JSON格式
  * @author(作者): lrfalse<wangliyou>
  * @date (开发日期): 2018/4/2 22:38
  **/
public class JsonValidator {
    ...
    /**
      * @Description(功能描述): 验证一个字符串是否是合法的JSON串
      * @author(作者): lrfalse<wangliyou>
      * @date (开发日期): 2018/4/2 22:38
      **/
